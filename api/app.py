...
client = OpenAI(
    api_key="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"
...
def submit():
    ...
    response_html = render_template("mood.html", mood=playlist, response=response, reply=reply, city=city, map_html=map_html)
